...
public class CachedUserInfoTokenServices implements ResourceServerTokenServices
{

    private final Logger logger = LoggerFactory.getLogger(CachedUserInfoTokenServices.class);
    ...
    private Map<String, Object> getMap(String path, String accessToken)
    {
        ...
        try
        {
            ...
            OAuth2AccessToken existingToken =
                restTemplate.getOAuth2ClientContext().getAccessToken();
            ...
            return restTemplate.getForEntity(path + "/" + accessToken, Map.class).getBody();
        }
        catch (Exception ex)
        {
            this.logger.warn(
